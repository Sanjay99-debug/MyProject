...
function Complain() {
 const [countries, setCountries] = useState([
  { id: 1, name: "Broken street light", complainnumber: "1", status: "pending", discription: "" },
  { id: 2, name: "Water leakage", complainnumber: "2", status: "done", discription: "" },
]);
    ...
    if (newCountry.trim() !== "") {
      const newId =
        countries.length > 0
          ...
          : 1;
      setCountries([...countries, { id: newId, name: newCountry,Complainno:Complainno,Description:Description,status:status }]);
      setNewCountry("");
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h4 className="mb-0">🌍 complain List</h4>
        <button
          className="btn btn-primary btn-sm"
          onClick={() => setShowAddModal(true)}
        >
          <i className="bi bi-plus-lg"></i> Add Complain
        </button>
      </div>
